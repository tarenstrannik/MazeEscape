...
namespace UnityEngine.InputSystem.OnScreen
{
    ...
    [AddComponentMenu("Input/On-Screen Stick Extended")]

    public class OnScreenStickExternalExtension : OnScreenControl, IPointerDownHandler, IPointerUpHandler, IDragHandler
    {
        ...
        public void BeginInteraction(Vector2 pointerPosition, Camera uiCamera)
        {
...
#if UNITY_EDITOR
        [CustomEditor(typeof(OnScreenStickExternalExtension))]
        internal class OnScreenStickExternalExtensionEditor : UnityEditor.Editor
        {
            ...
            public void OnEnable()
            {
                ...
                m_UseIsolatedInputActions = serializedObject.FindProperty(nameof(OnScreenStickExternalExtension.m_UseIsolatedInputActions));

                m_Behaviour = serializedObject.FindProperty(nameof(OnScreenStickExternalExtension.m_Behaviour));
                m_ControlPathInternal = serializedObject.FindProperty(nameof(OnScreenStickExternalExtension.m_ControlPath));
                m_MovementRange = serializedObject.FindProperty(nameof(OnScreenStickExternalExtension.m_MovementRange));
                m_DynamicOriginRange = serializedObject.FindProperty(nameof(OnScreenStickExternalExtension.m_DynamicOriginRange));
                m_PointerDownAction = serializedObject.FindProperty(nameof(OnScreenStickExternalExtension.m_PointerDownAction));
                m_PointerMoveAction = serializedObject.FindProperty(nameof(OnScreenStickExternalExtension.m_PointerMoveAction));
            }
            ...
            public override void OnInspectorGUI()
            {
                ...
                m_ShowDynamicOriginOptions.target = ((OnScreenStickExternalExtension)target).behaviour ==
                ...
                if (EditorGUILayout.BeginFadeGroup(m_ShowDynamicOriginOptions.faded))
                {
                    ...
                    {
                        ((OnScreenStickExternalExtension)target).UpdateDynamicOriginClickableArea();
                    }
                    EditorGUI.indentLevel--;
                }
